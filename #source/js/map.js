;(function() {
    ...
    var ymapInit = function() {
        ...
        ymaps.ready(function () {
            ...
            var mapCoordinates = $('.contacts__map').attr('data-coordinates');
            //берем аттрибут с адресом (берется из админки вп) из блока с картой
            var mapAddress = $('.contacts__map').attr('data-address');
            ...
            myPlacemark = new ymaps.Placemark(myMap.getCenter(), {
                ...
                iconImageHref: WPJS.siteUrl + '/img/icons/map-marker.png',
